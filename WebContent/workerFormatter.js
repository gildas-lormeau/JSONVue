...
function valueToHTML(value) {
  ...
  else if (value && value.constructor == Array) output += arrayToHTML(value);
  else if (valueType == 'object') output += objectToHTML(value);
...
function jsonToHTML(json, fnName) {
  ...
  if (fnName)
    output +=
      '<div class="callback-function">' + htmlEncode(fnName) + '(</div>';
  output += '<div id="json">';
